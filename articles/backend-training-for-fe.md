...
AI でアプリケーションが簡単に作れるようになった中、バックエンドの知識が全くないのは如何なものかと思い、簡単な CRUD を使っているアプリを作って、それを解説してもらうという方法で学習してみました！
...
今ならレビューができる気がします。
今回記事では触れなかった Middleware や Interceptor などの知識も含めてより深く学習して、バックエンドも深く理解していけるようにこれからも学習しようと思いました！

また、今回の学習のように AI を壁打ち相手にひたすら質問し続けるのはとてもよかったです。
知らない言語でもこうやって学べばキャッチアップがスムーズにいきそうだなと思いました。（AI が得意な言語に限るのだろうか...?）

わからない単語が出てきたら、「〇〇ってどういう意味？」と質問したり、理解できたとおもったら「まとめるとこういうことであってますか？」と自分の言葉でまとめたりすることで理解が促進されているのを実感しました！

最近のモデルはかなりわかりやすいコードを出してくれると思うので、それをベースに学習できて良かったです。

長々と見ていただきありがとうございました！

うぐいすソリューションズ Advent Calendar 2025 明日は PM などのロールで活躍されている長田さんになります！
皆様、乞うご期待！！
