...
この試みをしたのは、僕自身がバックエンドの実装あんまり理解していないので理解したかったということと、
社内でとある記事をベースにバックエンドの型安全の話をしている時に「サービスロジックで型チェックしているのが違和感を感じる」という話が出たことがきっかけでした。
（正直僕は全く気づいていなかったのですが、どうやら責務的に違うと思うよということでした。）
その話をきっかけに、「どこがどういう責務を持つのか？」をちゃんと把握するべきだなと感じました。
...
Java も遠い昔に経験があるのですが、Java8 の知識で止まっているので NestJS の方が記憶が新しいので理解しやすそうだなという判断です。
